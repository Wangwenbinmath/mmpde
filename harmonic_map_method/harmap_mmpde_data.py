...
from fealpy.old.geometry import RectangleDomain
...
# mesh_data = {
#     'from_box':TriangleMesh.from_box([0,1,0,1],nx=30,ny=30),
#     'from_box_Lshape':TriangleMesh.from_box([0,1,0,1],nx=40,ny=40,threshold=thr),
#     'from_domain_distmesh':TriangleMesh.from_domain_distmesh(domain),
#     'from_polygon_gmsh_Lshape':TriangleMesh.from_polygon_gmsh(vertices, h),
# }
function_data = {
    'u1':'(1-exp(10*(x-1))*sin(pi*y))',
